...
public class TestWorkProcessorPipelineSourceOperator
{
    ...
    public void testWorkProcessorPipelineSourceOperator()
    {
        ...
        pipelineOperator.getOperatorContext().getNestedOperatorStats().get().forEach(
        ...
        List<OperatorStats> operatorStats = pipelineOperator.getOperatorContext().getNestedOperatorStats().get();
        ...
        operatorStats = pipelineOperator.getOperatorContext().getNestedOperatorStats().get();
