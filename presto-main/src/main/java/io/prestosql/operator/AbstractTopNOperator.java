 ...
 */
public abstract class AbstractTopNOperator
{
    ...
    {
        this.localUserMemoryContext = aggregatedMemoryContext.newLocalMemoryContext(AbstractTopNOperator.class.getSimpleName());
