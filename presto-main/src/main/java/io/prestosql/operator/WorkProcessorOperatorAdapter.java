        ...
        implements Operator
{
    ...
    public WorkProcessorOperatorAdapter(
            OperatorContext operatorContext,
            AdapterWorkProcessorOperatorFactory workProcessorOperatorFactory)
    {
    ...
    public class PageBuffer
    {
        ...
        private void add(Page page)
        {
            ...
            if (!isEmpty()) {
                operatorContext.localUserMemoryContext().setBytes(page.getSizeInBytes());
            }
        }
