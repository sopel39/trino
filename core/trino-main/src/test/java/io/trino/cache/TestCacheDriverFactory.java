...
public class TestCacheDriverFactory
{
    ...
    public void testCreateDriverWithRemainingPredicateDynamicFilterFallback()
    {
        ...
        CacheSplitId fullSplitIdWithPredicate = appendRemainingPredicates(
                SPLIT_ID,
                Optional.of(tupleDomainCodec.toJson(normalizeTupleDomain(remainingEnforcedDynamicPredicate.transformKeys(columnHandles::get)))),
                Optional.of(tupleDomainCodec.toJson(normalizeTupleDomain(remainingUnenforcedDynamicPredicate.transformKeys(columnHandles::get)))));
