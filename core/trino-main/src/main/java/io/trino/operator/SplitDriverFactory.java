...
public interface SplitDriverFactory
{
    ...
    DriverWithFuture createDriver(DriverContext driverContext, Optional<ScheduledSplit> split);

    default DriverWithFuture createDriver(DriverContext driverContext)
    {
    ...
    record DriverWithFuture(Optional<Driver> driver, ListenableFuture<Void> future) {}
}
